...
Tags: restrict content, access control, permissions, post access, user access
...
[PublishPress Permissions](https://publishpress.com/permissions) allows you to enable or deny access to posts, pages, categories, tags and more. You can apply these permissions for user roles, individual users, members, and even custom groups.
...
PublishPress Permissions allows you to create your own user groups. Imagine you want access control for a single post. Instead of creating a new user role and applying all the permissions, you can easily add those users to a group. This is a simple and more flexible alternative to user roles. You can also prevent users from reading or editing content if they are not in a specific group. By default, this plugin gives you sample groups that include all Logged in and Logged out users so you can easily set public and private content.
...
The most common way to use this feature is to restrict users in the Editor role so that they can only edit posts written by other Editors. This is because Editors are the only default WordPress role that can edit content (except for Administrators). This feature provides some of the most powerful user access in WordPress.
